...
const WA_NUMBER = import.meta.env.VITE_WA_BUSINESS_NUMBER || '919372333633';
...
export default function WhatsAppRegisterQR({ compact = false }) {
  ...
  return (
    <div className="border border-green-200 bg-green-50 rounded-xl p-5 text-center">
      ...
      <p className="text-xs text-green-600 mb-4">Scan QR or tap the link to start</p>
      ...
      <div className="mt-4 bg-white rounded-lg px-3 py-2 text-left space-y-1">
        ...
        <p className="text-xs text-gray-500">2. Send <strong>REGISTER</strong> on WhatsApp</p>
        <p className="text-xs text-gray-500">3. Follow the 3-step chat flow</p>
