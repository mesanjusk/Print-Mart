                    ...
                    <div className="space-y-2">
                      {inq.sellerInterests.map((si, idx) => (
                        <div key={idx} className="flex items-center justify-between bg-white rounded px-3 py-2 border border-green-100">
                          ...
                          {si.sellerPhone ? (
                            <a
                              href={waLink(si.sellerPhone, `Hi ${si.sellerBusiness || si.sellerName}, I found you on PrintMart. I need ${inq.quantity} ${inq.unit} of ${inq.product?.name}. Can you share your best price?`)}
                              target="_blank"
                              rel="noopener noreferrer"
